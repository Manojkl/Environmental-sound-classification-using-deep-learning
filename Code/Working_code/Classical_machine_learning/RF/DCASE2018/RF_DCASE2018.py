...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/random_forest_DCASE2018_default_parameter.pkl', 'wb') as f:
...
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/classification_report_RF_default_parameter_DCASE2018.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(rf_model, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/RF_DCASE2018_default_parameter.pdf')
print(report)
...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/RF_DCASE2018_optimized_parameter.pkl', 'wb') as f:
    pickle.dump(model, f)
...
report_dic = classification_report(prediction, y_test, output_dict=True)
df = pd.DataFrame(report_dic).transpose()
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/classification_report_RF_optimized_parameter_DCASE2018.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(model, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/RF/DCASE2018/RF_DCASE2018_optimized_parameter.pdf')
print(report)


telegram_bot_sendtext(str("RF DCASE2018 completed"))