...
#SBATCH --output /home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K/output/US8K_job_tf.%N.%j.out # filename for STDOUT (%N: nodename, %j: j$
#SBATCH --error /home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K/output/US8K_tf.%N.%j.err  # filename for STDERR
# to load CUDA module
module load cuda
...
cd /home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K
# run the script
python NB_US8K.py
