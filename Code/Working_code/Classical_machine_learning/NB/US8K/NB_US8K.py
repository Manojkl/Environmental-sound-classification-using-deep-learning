...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K/NB_model_US8K_default_parameter.pkl', 'wb') as f:
...
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K/classification_report_NB_default_parameter_US8K.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(nb_model, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/NB/US8K/NB_US8K_default_parameter.pdf')
print(report)

telegram_bot_sendtext(str("NB US8K completed"))