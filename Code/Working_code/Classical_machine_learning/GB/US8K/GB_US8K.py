...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/gbc_US8K_default_parameter.pkl', 'wb') as f:
...
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/classification_report_GBC_default_parameter_US8K.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(gbc_model, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/GBC_US8K_default_parameter.pdf')
print(report)
...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/GBC_US8K_optimized_parameter.pkl', 'wb') as f:
    pickle.dump(model, f)
...
report_dic = classification_report(prediction, y_test, output_dict=True)
df = pd.DataFrame(report_dic).transpose()
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/classification_report_GBC_optimized_parameter_US8K.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(model, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/GB/US8K/GBC_US8K_optimized_parameter.pdf')
print(report)

telegram_bot_sendtext(str("Completed GB US8K"))