...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/DCASE2018_SVM_default_parameter.pkl', 'wb') as f:
    pickle.dump(clf, f)
...
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/classification_report_SVM_default_parameter_DCASE2018.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(clf, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/SVM_DCASE2018_default_parameter.pdf')
print(report)
...
for score in scores:
    ...
    with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/DCASE2018_SVM_optimized_parameter_'+str(score)+'.pkl', 'wb') as f:
        pickle.dump(clf, f)
    ...
    report_dic = classification_report(prediction, y_test, output_dict=True)
    df = pd.DataFrame(report_dic).transpose()
    df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/classification_report_SVM_optimized_parameter_DCASE2018_'+str(score)+'.csv')

    fig, ax = plt.subplots(figsize=(15, 15))
    plot_confusion_matrix(clf, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
    plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/SVM/DCASE2018/SVM_DCASE2018_optimized_parameter.pdf')
    print(report)

telegram_bot_sendtext("Completed SVM DCASE2018")