...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/KNN_DCASE2018_default_parameter.pkl', 'wb') as f:
    pickle.dump(knn, f)
...
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/classification_report_KNN_default_parameter_DCASE2018.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(knn, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/KNN_DCASE2018_default_parameter.pdf')
print(report)
...
with open('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/KNN_DCASE2018_optimized_parameter.pkl', 'wb') as f:
    pickle.dump(model, f)
...
report_dic = classification_report(prediction, y_test, output_dict=True)
df = pd.DataFrame(report_dic).transpose()
df.to_csv('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/classification_report_KNN_optimized_parameter_DCASE2018.csv')

fig, ax = plt.subplots(figsize=(15, 15))
plot_confusion_matrix(knn, x_test_scaled, y_test, ax=ax)  # doctest: +SKIP
plt.savefig('/home/mkolpe2s/rand/Classic_ML/Proper_method/KNN/DCASE2018/KNN_DCASE2018_optimized_parameter.pdf')
print(report)