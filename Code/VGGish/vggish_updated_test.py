...
def get_embeddings_of_all(files, data_type):
    ...
    total_ommitt = 0
    seg_num = 80
    testing = np.zeros((2851*seg_num,96,64,1))
    ...
    np.save(str("/home/mkolpe2s/rand/CNN/VGGish/vggish_keras/")+str(data_type)+"_class_value.npy",labels)
    np.save(str("/home/mkolpe2s/rand/CNN/VGGish/vggish_keras/")+str(data_type)+"_log_mel_value.npy",testing)
