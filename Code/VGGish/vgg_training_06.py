...
import wandb
wandb.init(project="vgg_training_01_dcase_1&2&3_frozen_layer")
...
set_trainable = False
for layer in vgg.layers:
    if layer.name in ['conv4/conv4_1', 'conv4/conv4_2']:
        set_trainable = True
    if set_trainable:
...
model.save(os.path.join("/scratch/mkolpe2s/CNN_dcase/", "vgg_training_06.h5"))